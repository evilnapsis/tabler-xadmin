...
class UserData extends Extra{
	...
	public $id, $name, $lastname, $username, $email, $password, $kind, $status, $created_at, $image;
	...
	public function update(){
		$sql = "update ".self::$tablename." set name=\"$this->name\",lastname=\"$this->lastname\",email=\"$this->email\",username=\"$this->username\",status=\"$this->status\",kind=\"$this->kind\" where id=$this->id";
		Executor::doit($sql);
	}
